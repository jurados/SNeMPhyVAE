import argparse
from model.settings import initial_settings
...
if __name__ == "__main__":
    ...
    parser.add_argument("-sn", "--spectra_nbins",    type=int,   required=False, help="Number of bins for the spectra")
    parser.add_argument("-sp", "--spectra_penalty",  type=float, required=False, help="Penalty for the spectra")
